...
public class HolidayUtil {
	...
	static Logger logger = LoggerFactory.getLogger(HolidayUtil.class);
	...
	/**
	 * 해당일자가 법정공휴일, 대체공휴일(isHolidayAlternate), 주말(isWeekend) 여부 확인
	 *
	 * @param date 양력날짜 (yyyyMMdd)
	 * @return 법정공휴일, 대체공휴일, 주말이면 true, 오류시 false
	 */
	 ...
	 * @return 대체 공휴 =  true
	 */
	public static boolean isHolidayAlternate(String date) {
