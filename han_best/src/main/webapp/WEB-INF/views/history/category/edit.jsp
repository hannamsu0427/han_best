...
<script type="text/javascript">
	...
	injectFile("/js/history/category.js");
						...
						<article>
							<div class="tabs">
								<ul>
									...
									<li class="p33"><a href="#" data-itsp-category-link="<c:out value="${HISTORY_CONFIG_SEQ}"/>" class="on"><span>카테고리 관리</span></a></li>
									<li class="p33"><a href="#" data-itsp-record-link="<c:out value="${HISTORY_CONFIG_SEQ}"/>"><span>연혁 관리</span></a></li>
								</ul>
							</div>
							<div class="pt20">
								<div class="post_tbl">
									<form action="/iWORK/History/Category/saveProcData.do" method="post" name="fm" id="fm">
							...
							<div class="post_bottom">
								<div class="bt_list">
									<button type="button" name="" id="" class="bt bt_on" data-itsp-save-link="${empty data ? HISTORY_CONFIG_SEQ : data.configSeq}">확인</button>
									<button type="button" name="" id="" class="bt bt_nor" onclick="location.href='/iWORK/History/CategoryList.do?configSeq=${HISTORY_CONFIG_SEQ}'">목록</button>
								</div>
							</div>
