				...
				<div class="container">
					<div class="contents_inner">
						<article>
							<div class="tabs">
								<ul>
									<li class="${not empty data ? 'p33' : 'p100'}"><a href="#" class="on"><span>기본 설정</span></a></li>
									<c:if test="${not empty data }">
										<li class="p33"><a href="#" data-itsp-category-link="<c:out value="${data.seq}"/>"><span>카테고리 관리</span></a></li>
										<li class="p33"><a href="#" data-itsp-record-link="<c:out value="${data.seq}"/>"><span>연혁 관리</span></a></li>
									</c:if>
								</ul>
							</div>

							<form action="/iWORK/History/Config/saveProcData.do" name="fm" id="fm" method="post">
							...
							<div class="post_bottom">
								<div class="bt_list">
									...
									<button type="button" name="" id="" class="bt bt_nor" onclick="location.href='/iWORK/History/ConfigList.do'">목록</button>
								</div>
							</div>
