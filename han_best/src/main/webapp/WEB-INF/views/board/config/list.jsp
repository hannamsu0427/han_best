							...
							<div class="post_tbl">
								...
								<div class="post_list">
									<table class="grid">
										...
										<colgroup><col width="6%"><col width="6%"><col width="6%"><col width="*"><col width="10%"><col width="10%"><col width="10%"></colgroup>
										<thead>
											<tr>
												<th>선택</th>
												<th>No.</th>
