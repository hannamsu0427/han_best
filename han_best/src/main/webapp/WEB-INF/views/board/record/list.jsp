						...
						<article>
							<div class="tabs">
								<ul>
									...
									<li class="p25"><a href="#" data-itsp-record-link="<c:out value="${BOARD_CONFIG_SEQ}"/>" class="on"><span>게시물 관리</span></a></li>
							...
							<div class="post_bottom">
								<div class="bt_list">
									<c:choose>
										...
										<c:otherwise>
											<button type="button" name="" id="" class="bt bt_on" data-itsp-use-link="chkBox" data-itsp-delYn="Y">휴지통</button>
										</c:otherwise>
									</c:choose>
