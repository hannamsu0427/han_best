...
<script type="text/javascript">
	...
	injectFile("/js/major/curriculum.js");
						...
						<article>
							<div class="tabs">
								<ul>
									...
									<li style="width: 12.5%"><a href="CurriculumList.do?aboutSeq=<c:out value="${MAJOR_ABOUT_SEQ}"/>" class="on"><span>교육과정</span></a></li>
							...
							<form action="/Major/Curriculum/saveProcData.do" name="fm" id="fm" method="post">
								...
								<table class="grid view">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="pt5 pb5">
													<textarea name="contents" id="contents" rows="5" class="p100" placeholder="내용"><c:out value="${cmutls:removeScript(data.contents) }"/></textarea>
												</div>
											</td>
										</tr>
									</tbody>
