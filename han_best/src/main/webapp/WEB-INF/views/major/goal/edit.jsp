						...
						<article>
							<div class="tabs">
								<ul>
									...
									<li style="width: 12.5%"><a href="GoalList.do?aboutSeq=<c:out value="${MAJOR_ABOUT_SEQ}"/>" class="on"><span>교육목표</span></a></li>
							...
							<form action="/Major/Goal/saveProcData.do" name="fm" id="fm" method="post" enctype="multipart/form-data">
								...
								<table class="grid view">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<div class="pt5 pb5">
													<textarea name="goalTxt" id="goalTxt" rows="5" class="p100" placeholder="내용"><c:out value="${cmutls:removeScript(data.goalTxt) }"/></textarea>
												</div>
											</td>
										</tr>
									</tbody>
							...
							<div class="post_bottom">
								<div class="bt_list">
									...
									<button type="button" name="" id="" class="bt bt_nor" onclick="location.href='/iWORK/Major/GoalList.do'">목록</button>
								</div>
							</div>
