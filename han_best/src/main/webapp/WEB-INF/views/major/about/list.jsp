							...
							<div class="post_tbl">
											...
											<ul class="dp_inline tc">
												<li class="p15">
													...
													<select id="searchBy" title="" class="p100">
														...
														<option value="majorName" <c:if test="${'majorName' eq searchBy}">selected="selected"</c:if>>제목</option>
														<option value="majorAboutTxt" <c:if test="${'majorAboutTxt' eq searchBy}">selected="selected"</c:if>>내용</option>
													</select>
												</li>
												<li class="p30">
								...
								<div class="post_list">
									<table class="grid">
										...
										<colgroup><col width="6%"><col width="6%"><col width="*"><col width="10%" span="2"><col width="15%"><col width="10%"></colgroup>
										<thead>
											<tr>
												<th>선택</th>
												<th>No.</th>
												<th>게시판명</th>
												<th colspan="2">기능설정</th>
												<th>생성일</th>
												<th>사용여부</th>
											</tr>
										</thead>
										<tbody>
											...
											<c:forEach items="${dataList}" var="data">
												<tr>
													...
													<td><button type="button" name="" value="" title="" class="bt_inner" data-itsp-edit-link="<c:out value="${data.seq }"/>">계열정보설정</button></td>
													<td><button type="button" name="" value="" title="" class="bt_inner" data-itsp-application-edit-link="<c:out value="${data.seq }"/>">원서정보설정</button></td>
