				...
				<div class="container">
					<div class="contents_inner">
						<article>
							<div class="tabs">
								<ul>
									<li <c:if test="${not empty data }">style="width: 12.5%"</c:if>><a href="#" class="on"><span>기본 설정</span></a></li>
							...
							<form action="/Major/About/saveProcData.do" name="fm" id="fm" method="post" enctype="multipart/form-data">
							...
							<div class="post_tbl">
								...
								<table class="grid view">
									...
									<tbody>
										...
										<tr>
											<th><span class="pl10">배경화면</span></th>
											<td>
												<div class="row">
													<ul class="pb5">
														<c:if test="${not empty data.attachFileList}">
															<c:forEach items="${data.attachFileList }" var="file">
																<li class="add_field">
																	...
																	<span class="req">이미지 사이즈 1920x436</span>
																	<ul class="add_edit">
										...
										<tr>
											<th><span class="req pl10">교과과정 ICON</span></th>
											<td>
												<div class="row">
													<ul class="dp_inline">
														<li><input type="radio" name="icoCurriculum" id="icoCurriculumY" value="Y" ${'N' ne data.icoCurriculum ? 'checked="checked"':'' }><label for="icoCurriculumY" class="pl5">사용</label></li>
														<li><input type="radio" name="icoCurriculum" id="icoCurriculumN" value="N" ${'N' eq data.icoCurriculum ? 'checked="checked"':'' }><label for="icoCurriculumN" class="pl5">미사용</label></li>
													</ul>
												</div>
											</td>
										</tr>
										...
										<tr>
											<th><span class="req pl10">원서접수 ICON</span></th>
											<td>
												<div class="row">
													<ul class="dp_inline">
														<li><input type="radio" name="icoApply" id="icoApplyY" value="Y" ${'N' ne data.icoApply ? 'checked="checked"':'' }><label for="icoApplyY" class="pl5">사용</label></li>
														<li><input type="radio" name="icoApply" id="icoApplyN" value="N" ${'N' eq data.icoApply ? 'checked="checked"':'' }><label for="icoApplyN" class="pl5">미사용</label></li>
													</ul>
												</div>
											</td>
										</tr>
										<tr>
											<th><span class="req pl10">계열 제목</span></th>
											<td><div class="row"><input type="text" name="majorName" id="majorName" value="<c:out value="${data.majorName}"/>" title="계열 제목" placeholder="계열 제목" class="p100"></div></td>
										</tr>
										<tr>
											<th><span class="req pl10">내용</span></th>
											<td>
												<div class="pt5 pb5">
													<textarea name="majorAboutTxt" id="majorAboutTxt" rows="5" class="p100" placeholder="내용"><c:out value="${cmutls:removeScript(data.majorAboutTxt) }"/></textarea>
												</div>
											</td>
										</tr>
									</tbody>
							...
							<div class="post_tbl">
								<div class="grid_top">
									<div class="ls"><h3>취득가능 학위</h3></div>
									<div class="rs"><span class="req fs13">내용은 '<strong>||</strong>' 로 구분하여 등록 해주시기 바랍니다.</span></div>
								</div>
								...
								<table class="grid view">
									...
									<tbody>
										<tr>
											...
											<td>
												<div class="pt5 pb5">
													<textarea name="dash" id="dash" rows="5" class="p100" placeholder="취득가능 학위"><c:out value="${cmutls:removeScript(data.dash) }"/></textarea>
												</div>
											</td>
										</tr>	
									</tbody>
