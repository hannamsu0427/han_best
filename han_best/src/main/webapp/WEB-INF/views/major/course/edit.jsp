				...
				<div class="container">
					<div class="contents_inner">
						<article>
							...
							<form action="/Major/Course/saveProcData.do" name="fm" id="fm" method="post">
							...
							<div class="post_tbl">
								...
								<table class="grid view">
									...
									<tbody>
										...
										<tr>
											<th><span class="req pl10">타입</span></th>
											<td>
												<div class="row">
													<ul class="dp_inline">
														<li><input type="radio" name="type" id="type_Editor" value="Editor" <c:if test="${'Editor' eq data.type || empty data}">checked="checked"</c:if>><label for="type_Editor" class="pl5">Editor</label></li>
														<li><input type="radio" name="type" id="type_Include" value="Include" <c:if test="${'Include' eq data.type}">checked="checked"</c:if>><label for="type_Jsp" class="pl5">File Include</label></li>
													</ul>
												</div>
											</td>
										</tr>
										...
										<tr>
											<th><span class="req pl10">File 경로</span></th>
											<td><div class="row"><input type="text" name="includePath" id="includePath" value="${empty data ? '#' : data.includePath }" placeholder="include할 file경로를 기입해주세요." class="p100"></div></td>
										</tr>
										<tr>
											<th><span class="req pl10">내용</span></th>
											<td>
												<div class="pt5 pb5">
													<textarea name="contents" id="contents" rows="5" class="p100" data-itsp-title="내용" data-itsp-html-editor>${cmutls:removeScript(data.contents) }</textarea>
												</div>
											</td>
										</tr>
									</tbody>
							...
							<div class="post_bottom">
								<div class="bt_list">
									...
									<button type="button" name="" id="" class="bt bt_nor" onclick="location.href='/iWORK/Major/CurriculumList.do'">목록</button>
								</div>
							</div>
