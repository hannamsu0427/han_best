...
<script type="text/javascript">
	...
	injectFile("/js/editor/config.js");
						...
						<article>
							<div class="post_tbl">
										...
										<fieldset>
											...
											<ul class="dp_inline tc">
												<li class="p15">
													...
													<select id="searchBy" name="searchBy" title="" class="p100">
												...
												<li class="p30">
													<label for="searchValue" class="blind">검색어 입력</label><input type="text" placeholder="검색어 입력" id="searchValue" name="searchValue" value="<c:out value="${searchValue }"/>" class="p100" maxlength="50" data-itsp-len-range=",50" tabindex="1">
												</li>
												<li class="">
								...
								<div class="post_list">
									<table class="grid">
										<caption>목록</caption>
										<colgroup><col width="6%"><col width="6%"><col width="*"><col width="30%"><col width="10%"><col width="10%"></colgroup>
										<thead>
											<tr>
												<th>선택</th>
												<th>No.</th>
										...
										<tbody>
											...
											<c:forEach items="${dataList}" var="data">
												<tr>
													...
													<td>${totalCount - data.rnum+1 }</td>
													<td><c:out value="${data.title}"/></td>
													<td><c:out value="${data.explanation}"/></td>
