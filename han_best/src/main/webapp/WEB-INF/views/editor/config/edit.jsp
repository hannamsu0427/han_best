						...
						<article>
							<div class="tabs">
								<ul>
									...
									<c:if test="${not empty data }">
										<li class="p50"><a href="#" data-itsp-record-link="<c:out value="${data.seq}"/>"><span>내용 관리</span></a></li>
									</c:if>
								</ul>
							</div>

							<form action="/iWORK/Editor/Config/saveProcData.do" name="fm" id="fm" method="post">
							...
							<div class="post_tbl">
								...
								<table class="grid view">
									...
									<tbody>
										...
										<tr>
											<th><span class="pl10">설명</span></th>
											<td><div class="row"><input type="text" name="explanation" id="explanation" value="<c:out value="${data.explanation}"/>" title="설명" placeholder="설명" class="p100"></div></td>
										</tr>
									</tbody>
								</table>
							</div>
							...
							<div class="post_bottom">
								<div class="bt_list">
									...
									<button type="button" name="" id="" class="bt bt_nor" onclick="location.href='/iWORK/Editor/ConfigList.do'">목록</button>
								</div>
							</div>
