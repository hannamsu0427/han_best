					...
					<div class="contents_inner">
						<article>
							...
							<div class="post_tbl">
								...
								<div class="post_list">
									<table class="grid">
										...
										<colgroup><col width="8%"><col width="8%"><col width=""><col width="10%"><col width="10%"><col width="10%"></colgroup>
										<thead>
											<tr>
												<th>선택</th>
												<th>순번</th>
										...
										<tbody id="changeOrder">
											<c:forEach items="${dataList}" var="data">
												<tr data-itsp-seq="<c:out value="${data.seq}"/>" data-itsp-orderNum="<c:out value="${data.orderNum}"/>">
													...
													<td><c:out value="${data.orderNum}"/></td>
													<td>
														<div class="subject">
							...
							<div class="post_bottom">
								<div class="bt_list">
									<ul>
										<li><button type="button" name="" id="" class="bt bt_roll" data-itsp-orderNum-link>순서 변경</button></li>
										<li><button type="button" name="" id="" class="bt bt_on" data-itsp-edit-link="0">신규등록</button></li>
