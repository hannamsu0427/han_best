				...
				<div class="container">
					<div class="contents_inner">
						<article>
							...
							<form action="/iWORK/Facility/Config/saveProcData.do" name="fm" id="fm" method="post">
							...
							<div class="post_bottom">
								<div class="bt_list">
									...
									<button type="button" name="" id="" class="bt bt_nor" onclick="location.href='/iWORK/Facility/ConfigList.do'">목록</button>
								</div>
							</div>
