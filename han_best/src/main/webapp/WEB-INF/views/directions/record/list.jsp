				...
				<div class="container">
					<div class="contents_inner">
						<article>
							<div class="post_tbl">
								<div class="grid_top">
									<div class="ls"><h3>오시는길 관리</h3></div>
								</div>
								...
								<div class="post_list">
									<table class="grid">
										...
										<colgroup><col width="8%"><col width="8%"><col width="*"><col width="10%"><col width="10%"></colgroup>
										<thead>
											<tr>
												<th>선택</th>
												<th>No.</th>
										...
										<tbody>
											<c:forEach items="${dataList}" var="data">
												<tr>
													...
													<td>
														<div class="subject">
															<a href="#" class="subject_click" data-itsp-edit-link="<c:out value="${data.seq}"/>"><c:out value="${data.title}"/></a>
														</div>
													</td>
													<td>${data.regName }</td>
							...
							<div class="post_bottom">
								<div class="bt_list">
									<button type="button" name="" id="" class="bt bt_on" data-itsp-edit-link="0">작성</button>
